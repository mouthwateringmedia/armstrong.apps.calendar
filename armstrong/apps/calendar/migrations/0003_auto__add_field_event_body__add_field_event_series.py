...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('calendar_event', 'body',
                      self.gf('django.db.models.fields.TextField')(default='This is the event body'),
                      keep_default=False)

        # Adding field 'Event.series'
        db.add_column('calendar_event', 'series',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar.Event'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.body'
        db.delete_column('calendar_event', 'body')

        # Deleting field 'Event.series'
        db.delete_column('calendar_event', 'series_id')
