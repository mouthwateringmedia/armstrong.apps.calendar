...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('calendar_event', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 4, 16, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.start_time'
        db.add_column('calendar_event', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column('calendar_event', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.start_date'
        db.delete_column('calendar_event', 'start_date')

        # Deleting field 'Event.start_time'
        db.delete_column('calendar_event', 'start_time')

        # Deleting field 'Event.end_time'
        db.delete_column('calendar_event', 'end_time')
